...
{
    [SerializeField] private bool isWalking; //The trick is that this variable is tracked in dinosaur animator


    [SerializeField] private GameObject dinosaur;
    [SerializeField] private Text rewindIndication;
    ...
    private void FixedUpdate()
    {
        ...
        if (Input.GetKey(KeyCode
                .Space)) //Didnt want to clutter RewindByKeyPress.cs with this "unnecessaryness" and didnt want to add another script just for this. So it is here (i know, it is ugly)
        {
